...
print('dpc',max_Dc*100,t['Dc(MBD)'],max_Fmeasure, max_randIndex,max_entropy,t['dPTime'],t['matrixTime'],t['localdensityTime'],t['relativedistanceTime'],t['ccidentificationTime'],t['clusterassignTime'])
